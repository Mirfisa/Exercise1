...
console.log("a) var NAME; Valid variable name")

console.log("b) var $num1;  Valid variable name")

console.log("c) var typeof;  Cannot use reserved keywords")

console.log("d) var first-name;  Cannot have hyphen in variable name")

console.log("e) var attempt_2; Valid variable name")

console.log("f) var 2ndAttempt; Cannot start with a number")

console.log("g) var full name; Cannot have space in variable name")
